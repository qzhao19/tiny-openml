...
public:
    /**
     * Default constructor of logistic regression.
    */
    ...
    LogisticRegression(): BaseLinearModel<DataType>(true),
            alpha_(0.1), 
            lambda_(0.0001), 
            tol_(0.0001), 
            l1_ratio_(1.0),
